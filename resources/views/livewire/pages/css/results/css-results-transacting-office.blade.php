          ...
          <div class="container-fluid">
              <div class="row mb-2">
                  <div class="col-sm-6">
                    @switch($office)
                      @case('0')
                        <h1 class="m-0 text-dark"><span class="text-primary">Client Satisfaction Measurement Results</span><br>Transacting Office: PITAHC Central Office</h1>
                          @break
                      @case('1')
                        <h1 class="m-0 text-dark"><span class="text-primary">Client Satisfaction Measurement Results</span><br>Transacting Office: Research and Development Division</h1>
                          @break
                      @case('2')
                        <h1 class="m-0 text-dark"><span class="text-primary">Client Satisfaction Measurement Results</span><br>Standards and Accreditation Division</h1>
                          @break
                      @case('3')
                        <h1 class="m-0 text-dark"><span class="text-primary">Client Satisfaction Measurement Results</span><br>Transacting Office: Social Advocacy and Training Division</h1>
                          @break
                      @case('4')
                        <h1 class="m-0 text-dark"><span class="text-primary">Client Satisfaction Measurement Results</span><br>Transacting Office: Finance Division</h1>
                          @break
                      @case('5')
                        <h1 class="m-0 text-dark"><span class="text-primary">Client Satisfaction Measurement Results</span><br>Transacting Office: Management Services Division</h1>
                          @break
                      @case('6')
                        <h1 class="m-0 text-dark"><span class="text-primary">Client Satisfaction Measurement Results</span><br>Transacting Office: Administrative Division</h1>
                          @break
                      @case('7')
                        <h1 class="m-0 text-dark"><span class="text-primary">Client Satisfaction Measurement Results</span><br>Transacting Office: Cagayan Valley Herbal Processing Plant</h1>
                          @break
                      @case('8')
                        <h1 class="m-0 text-dark"><span class="text-primary">Client Satisfaction Measurement Results</span><br>Transacting Office: Tacloban Herbal Processing Plant</h1>
                          @break
                      @case('9')
                        <h1 class="m-0 text-dark"><span class="text-primary">Client Satisfaction Measurement Results</span><br>Transacting Office: Davao Herbal Processing Plant</h1>
                          @break
                      @case('10')
                        <h1 class="m-0 text-dark"><span class="text-primary">Client Satisfaction Measurement Results</span><br>Transacting Office: Bids and Awards Committee</h1>
                          @break
                      @case('11')
                        <h1 class="m-0 text-dark"><span class="text-primary">Client Satisfaction Measurement Results</span><br>Transacting Office: Office of the Director General</h1>
                          @break
                      @case('12')
                        <h1 class="m-0 text-dark"><span class="text-primary">Client Satisfaction Measurement Results</span><br>Transacting Office: Business Development Department</h1>
                          @break
                  @endswitch
                  </div>
                  <div class="col-sm-6">
                ...
                <div class="row">
                    <div class="col-lg-3">
                        <div class="card">
                            ...
                            <div class="card-body">
                              <label class="my-1 mr-2">Year</label>
                              <a href="{{ route('css-results-transacting-office', ['param1' => 2025, 'param2' => $office]) }}" class="btn {{ $param1==2025 ? 'btn-success' : 'btn-secondary' }} btn-lg btn-block">2025</a>
                              <a href="{{ route('css-results-transacting-office', ['param1' => 2024, 'param2' => $office]) }}" class="btn {{ $param1==2024 ? 'btn-success' : 'btn-secondary' }} btn-lg btn-block">2024</a>
                              <a href="{{ route('css-results-transacting-office', ['param1' => 2023, 'param2' => $office]) }}" class="btn {{ $param1==2023 ? 'btn-success' : 'btn-secondary' }} btn-lg btn-block">2023</a>
                              <a href="{{ route('css-results-transacting-office', ['param1' => 2022, 'param2' => $office]) }}" class="btn {{ $param1==2022 ? 'btn-success' : 'btn-secondary' }} btn-lg btn-block">2022</a>
                              <hr>
                              <label class="my-1 mr-2">Central Office</label>
                              <a href="{{ route('css-results', ['param' => 2025]) }}" class="btn btn-secondary btn-lg btn-block">PITAHC Overall</a>                  
                              <a href="{{ route('css-results-transacting-office', ['param1' => 2025, 'param2' => 0]) }}" class="btn {{ $office==0 ? 'btn-success' : 'btn-secondary' }} btn-lg btn-block">PITAHC Central Office Only</a>
                              <hr>
                              <label class="my-1 mr-2">Divisions and Department</label>
                              <a href="{{ route('css-results-transacting-office', ['param1' => 2025, 'param2' => 1]) }}" class="btn {{ $office==1 ? 'btn-success' : 'btn-secondary' }} btn-lg btn-block">Research and Development Division</a>
                              <a href="{{ route('css-results-transacting-office', ['param1' => 2025, 'param2' => 2]) }}" class="btn {{ $office==2 ? 'btn-success' : 'btn-secondary' }} btn-lg btn-block">Standards and Accreditation Division</a>
                              <a href="{{ route('css-results-transacting-office', ['param1' => 2025, 'param2' => 3]) }}" class="btn {{ $office==3 ? 'btn-success' : 'btn-secondary' }} btn-lg btn-block">Social Advocacy and Training Division</a>
                              <a href="{{ route('css-results-transacting-office', ['param1' => 2025, 'param2' => 4]) }}" class="btn {{ $office==4 ? 'btn-success' : 'btn-secondary' }} btn-lg btn-block">Finance Division</a>
                              <a href="{{ route('css-results-transacting-office', ['param1' => 2025, 'param2' => 5]) }}" class="btn {{ $office==5 ? 'btn-success' : 'btn-secondary' }} btn-lg btn-block">Management Services Division</a>
                              <a href="{{ route('css-results-transacting-office', ['param1' => 2025, 'param2' => 6]) }}" class="btn {{ $office==6 ? 'btn-success' : 'btn-secondary' }} btn-lg btn-block">Administrative Division</a>
                              <a href="{{ route('css-results-transacting-office', ['param1' => 2025, 'param2' => 10]) }}" class="btn {{ $office==10 ? 'btn-success' : 'btn-secondary' }} btn-lg btn-block">Bids and Awards Committee</a>
                              <a href="{{ route('css-results-transacting-office', ['param1' => 2025, 'param2' => 11]) }}" class="btn {{ $office==11 ? 'btn-success' : 'btn-secondary' }} btn-lg btn-block">Office of the Director General</a>
                              <a href="{{ route('css-results-transacting-office', ['param1' => 2025, 'param2' => 12]) }}" class="btn {{ $office==12 ? 'btn-success' : 'btn-secondary' }} btn-lg btn-block">Business Development Department</a>
                              <hr>
                              <label class="my-1 mr-2">Herbal Processing Plants</label>
                              <a href="{{ route('css-results-transacting-office', ['param1' => 2025, 'param2' => 7]) }}" class="btn {{ $office==7 ? 'btn-success' : 'btn-secondary' }} btn-lg btn-block">Cagayan Valley Herbal Processing Plants</a>
                              <a href="{{ route('css-results-transacting-office', ['param1' => 2025, 'param2' => 8]) }}" class="btn {{ $office==8 ? 'btn-success' : 'btn-secondary' }} btn-lg btn-block">Tacloban Herbal Processing Plants</a>
                              <a href="{{ route('css-results-transacting-office', ['param1' => 2025, 'param2' => 9]) }}" class="btn {{ $office==9 ? 'btn-success' : 'btn-secondary' }} btn-lg btn-block">Davao Herbal Processing Plants</a>
                          </div>
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                      <div class="row">
                                          <div class="col-lg-12">
                                            <h2 style="text-align:center">CY {{ $param1 }}</h2>
                                              <h3>Respondent’s Demographic</h3>
                                          </div>
                                          <div class="col-lg-6">
                                              <p class="indent">
                                                  A total of {{ App\Http\Livewire\Pages\Css\Results\CssResultsTransactingOffice::convertNumberToWords($total_css_responses)  }} ({{$total_css_responses}}) respondents served by PITAHC from January to {{ $param1 == date("Y") ? date("M") : "December" }} {{ $param1 }} have submitted accomplished PITAHC CSS forms. There were no age group included in the survey forms only the sex and profession/identification of the respondents were reflected.
                                              </p>
                                      ...
                                      <div class="row">
                                          <div class="col-lg-6">
                                              <p>For the profession or identification of the respondents, the approved CSS forms have pre-listed the possible clients that PITAHC will be serving. Among the {{ App\Http\Livewire\Pages\Css\Results\CssResultsTransactingOffice::convertNumberToWords($total_css_responses)  }} ({{$total_css_responses}}) respondents, {{ $firstLargestClientTypeCount }} of them ({{ number_format($firstLargestClientTypeCount/$total_css_responses*100, 0) }}%) were {{ $firstLargestClientTypeName == 'Others' ? 'Other' : $firstLargestClientTypeName }}s. <span style="display: {{ $secondLargestClientTypeName == 0 ? 'none' : '' }}">It was the followed by “{{ $secondLargestClientTypeName == 'Others' ? 'Other' : $secondLargestClientTypeName }}s” with {{ $secondLargestClientTypeCount }} clients. Third most number of respondents were classified themselves as {{ $thirdLargestClientTypeName == 'Others' ? 'Other' : $thirdLargestClientTypeName }}s with a total of {{ $thirdLargestClientTypeCount }} clients or {{ number_format($thirdLargestClientTypeCount/$total_css_responses*100, 0) }}% of the population.</span></p>
                                              <table class="table table-hover table-sm" style="text-align:center">
                                                  <thead>
                                                      <tr>
                                                      <th scope="col">Transacting of Client</th>
                                                      <th scope="col">Number of Respondents</th>
                                                      <th scope="col">Percent</th>
                                                      </tr>
                                                  </thead>
...
// }
  ...
  function updateChartA() {
      async function fetchData() {  
        ...
        const set_url = app_url+'/api/respondents_sex_transacting_office/'+year+'/'+office;
    ...
    fetchData().then(datapoints => {
        const Sex = datapoints.respondents_sex_transacting_office.map(
          function(index){
            return index.sex_type_name;
          })
        const SexCount = datapoints.respondents_sex_transacting_office.map(
          function(index){
            return index.count;
          })
  ...
  plugins: [ChartDataLabels]
    ...
    function updateChartB() {
      async function fetchData() {    
        ...
        const office = segments[segments.length - 1];
        const app_url = '{{ env('APP_URL') }}';
        const set_url = app_url+'/api/respondents_client_type_transacting_office/'+year+'/'+office;
        const response = await fetch(set_url);
        const datapoints = await response.json();
        return datapoints;
      };
    ...
    fetchData().then(datapoints => {
        const ClientType = datapoints.respondents_client_type_transacting_office.map(
          function(index){
            return index.client_type_name;
          })
        const ClientTypeCount = datapoints.respondents_client_type_transacting_office.map(
          function(index){
            return index.count;
          })
...
const configB = {
  ...
  plugins: [ChartDataLabels]
    ...
    // fetchData().then(datapoints => {
    //     const Criteria = datapoints.ratings_transacting_office.map(
    //       function(index){
    //         return index.criteria;
    //       })
    //     const Rating5 = datapoints.ratings_transacting_office.map(
    //       function(index){
    //         return index.rating_5;
    //       })
    //     const Rating4 = datapoints.ratings_transacting_office.map(
    //       function(index){
    //         return index.rating_4;
    //       })
    //     const Rating3 = datapoints.ratings_transacting_office.map(
    //       function(index){
    //         return index.rating_3;
    //       })
    //     const Rating2 = datapoints.ratings_transacting_office.map(
    //       function(index){
    //         return index.rating_2;
    //       })
    //     const Rating1 = datapoints.ratings_transacting_office.map(
    //       function(index){
    ...
    const office = segments[segments.length - 1];
    const app_url = '{{ env('APP_URL') }}';
    const set_url = app_url+'/api/ratings_transacting_office/' + year + '/' + office;
...
// Define an async function to call updateChartD and handle the data
async function fetchDataAndUpdateChartD() {
    const datapoints = await updateChartD();
    const Criteria = datapoints.ratings_transacting_office.map(function(index) {
        return index.criteria;
    });
    const Rating5 = datapoints.ratings_transacting_office.map(function(index) {
        return index.rating_5;
    });
    const Rating4 = datapoints.ratings_transacting_office.map(function(index) {
        return index.rating_4;
    });
    const Rating3 = datapoints.ratings_transacting_office.map(function(index) {
        return index.rating_3;
    });
    const Rating2 = datapoints.ratings_transacting_office.map(function(index) {
        return index.rating_2;
    });
    const Rating1 = datapoints.ratings_transacting_office.map(function(index) {
        return index.rating_1;
    });
    const Rating6 = datapoints.ratings_transacting_office.map(function(index) {
    ...
    //         return index.rating_1;
    //       })
    //     const Rating6 = datapoints.ratings_transacting_office.map(
    //       function(index){
    //         return index.rating_6;
    //       })
  ...
  options: {
    ...
    scales: {
      x: {
        ...
        // min: 40, // Minimum value for y-axis
        ticks: {
  ...
  plugins: [ChartDataLabels]
    ...
    function updateChartE() {
      async function fetchData() {   
        ...
        const office = segments[segments.length - 1];
        const app_url = '{{ env('APP_URL') }}';
        const set_url = app_url+'/api/average_transacting_office/'+year+'/'+office;
        const response = await fetch(set_url);
        const datapoints = await response.json();
        return datapoints;
      };
    ...
    fetchData().then(datapoints => {
        const Criteria = datapoints.average_transacting_office.map(
          function(index){
            return index.criteria;
          })
        const AverageRating = datapoints.average_transacting_office.map(
          function(index){
            return index.average_rating;
          })
        const OverallRating = datapoints.average_transacting_office.map(
          function(index){
  ...
  datasets: [
    {
      ...
      label: 'Transacting Office Average Rating/SQD',
      data: [0, 0, 0, 0, 0, 0, 0, 0, 0],
  ...
  options: {
    scales: {
      ...
      y: {
        ...
        // min: 3.00, // Minimum value for y-axis
        ticks: {
  ...
  plugins: [ChartDataLabels]
    ...
    function updateChartF() {
      async function fetchData() {  
        ...
        const office = segments[segments.length - 1];
        const app_url = '{{ env('APP_URL') }}';
        const set_url = app_url+'/api/respondents_availed_service_transacting_office/'+year+'/'+office;
        const response = await fetch(set_url);
        const datapoints = await response.json();
        return datapoints;
      };
    ...
    fetchData().then(datapoints => {
        const AvailedService = datapoints.respondents_availed_service_transacting_office.map(
          function(index){
            return index.availed_service_name_short;
          })
        const AvailedServiceCount = datapoints.respondents_availed_service_transacting_office.map(
          function(index){
            return index.count;
          })
...
const configF = {
  ...
  options: {
    plugins: {
      datalabels: {
        ...
        color: '#000', // You can customize the font color
        anchor: 'end',
        align: 'start',
        offset: 20,
        font: {
 ...
 function updateChartG() {
  async function fetchData() {  
    ...
    const office = segments[segments.length - 1];
    const app_url = '{{ env('APP_URL') }}';
    const set_url = app_url+'/api/respondents_client_group_transacting_office/'+year+'/'+office;
    const response = await fetch(set_url);
    const datapoints = await response.json();
    return datapoints;
  };
...
fetchData().then(datapoints => {
    const ClientGroup = datapoints.respondents_client_group_transacting_office.map(
      function(index){
        return index.client_group_name;
      })
    const ClientGroupCount = datapoints.respondents_client_group_transacting_office.map(
      function(index){
        return index.count;
      })
...
function updateChartH() {
  async function fetchData() {  
    ...
    const office = segments[segments.length - 1];
    const app_url = '{{ env('APP_URL') }}';
    const set_url = app_url+'/api/respondents_region_transacting_office/'+year+'/'+office;
    const response = await fetch(set_url);
    const datapoints = await response.json();
    return datapoints;
  };
...
fetchData().then(datapoints => {
    const Region = datapoints.respondents_region_transacting_office.map(
      function(index){
        return ( index.region_name ) ? index.region_name : 'Not Provided';
      })
    const RegionCount = datapoints.respondents_region_transacting_office.map(
      function(index){
        return index.count;
      })
...
function updateChartI() {
  async function fetchData() {  
    ...
    const office = segments[segments.length - 1];
    const app_url = '{{ env('APP_URL') }}';
    const set_url = app_url+'/api/respondents_awareness_response_transacting_office/'+year+'/'+office;
    const response = await fetch(set_url);
    const datapoints = await response.json();
    return datapoints;
  };
...
fetchData().then(datapoints => {
    const AwarenessResponse = datapoints.respondents_awareness_response_transacting_office.map(
      function(index){
        return index.awareness_response_name;
      })
    const AwarenessResponseCount = datapoints.respondents_awareness_response_transacting_office.map(
      function(index){
        return index.count;
      })
...
function updateChartJ() {
  async function fetchData() {  
    ...
    const office = segments[segments.length - 1];
    const app_url = '{{ env('APP_URL') }}';
    const set_url = app_url+'/api/respondents_visibility_response_transacting_office/'+year+'/'+office;
    const response = await fetch(set_url);
    const datapoints = await response.json();
    return datapoints;
  };
...
fetchData().then(datapoints => {
    const VisibilityResponse = datapoints.respondents_visibility_response_transacting_office.map(
      function(index){
        return ( index.visibility_response_name ) ? index.visibility_response_name : 'Not Applicable';
      })
    const VisibilityResponseCount = datapoints.respondents_visibility_response_transacting_office.map(
      function(index){
        return index.count;
      })
...
function updateChartK() {
  async function fetchData() {  
    ...
    const office = segments[segments.length - 1];
    const app_url = '{{ env('APP_URL') }}';
    const set_url = app_url+'/api/respondents_helpfulness_response_transacting_office/'+year+'/'+office;
    const response = await fetch(set_url);
    const datapoints = await response.json();
    return datapoints;
  };
...
fetchData().then(datapoints => {
    const HelpfulnessResponse = datapoints.respondents_helpfulness_response_transacting_office.map(
      function(index){
        return ( index.helpfulness_response_name ) ? index.helpfulness_response_name : 'Not Applicable';
      })
    const HelpfulnessResponseCount = datapoints.respondents_helpfulness_response_transacting_office.map(
      function(index){
        return index.count;
      })
